...
void main() async {
  ...
  // Initialize Firebase robustly - handles all edge cases
  ...
  // Initialize non-Firebase providers first
  try {
    await Future.wait([
      pinProvider.init(),
      themeProvider.init(),
  ...
  // Initialize family provider (uses Firestore if available)
  try {
  ...
  Widget build(BuildContext context) {
    return Consumer<ThemeProvider>(
      builder: (_, themeProvider, __) => MaterialApp(
        ...
        home: showOnboarding ? const OnboardingScreen() : const _WelcomeWrapper(),
      ),
    );
  }
}
