          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(color: primaryColor.withValues(alpha: 0.3), blurRadius: 6)],
              ),
              child: Center(
  ...
  Widget _buildAvatar(ChildModel child, Color borderColor) {
    ...
    if (_hasValidPhoto(child)) {
      avatarContent = ClipOval(
        child: Image.memory(base64Decode(child.photoBase64), width: size, height: size, fit: BoxFit.cover, gaplessPlayback: true,
