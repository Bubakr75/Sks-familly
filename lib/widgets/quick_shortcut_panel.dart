...
/// Sélecteur d'enfant inline (compact)
      ...
      itemBuilder: (_, i) {
        ...
        return GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color:
                  isSel ? Colors.cyanAccent.withOpacity(0.18) : Colors.white.withOpacity(0.06),
          ...
          builder: (_, scroll) => _bottomSheetContainer(
            child: ListView(
              ...
              children: [
                ...
                _childSelector(
                    fp.children, selectedId, (id) => setS(() => selectedId = id)),
                const SizedBox(height: 16),
              ...
              children: [
                ...
                _actionButton(
                  ...
                  onTap: () {
                    final child = fp.children
                        .firstWhere((c) => c.id == selectedId);
                    fp.addImmunity(selectedId, nbLines, reason);
                    Navigator.pop(ctx);
                    _showConfirmSnack(
                      context,
      ...
      return DraggableScrollableSheet(
        ...
        builder: (_, scroll) => _bottomSheetContainer(
          child: ListView(
            ...
            children: [
              _sheetHandle(),
              _sheetTitle('📊 Bilan du ${_formatDate(today)}', Colors.tealAccent),
              const SizedBox(height: 16),
              if (fp.children.isEmpty)
                ...
                ...fp.children.map((child) {
                  // Points du jour
                  final todayEntries = fp.getHistoryForChild(child.id).where((h) {
                  ...
                  final pointsToday = todayEntries.fold<int>(0, (s, h) => s + h.points);
                  final bonuses = todayEntries.where((h) => h.isBonus).length;
                  final penalties = todayEntries.where((h) => !h.isBonus).length;
                  ...
                  final color = pointsToday >= 0 ? Colors.greenAccent : Colors.redAccent;
                        ...
                        children: [
                          ...
                          Row(children: [
                            ...
                            if (avgNote != null) ...[
                              const SizedBox(width: 8),
                              _statChip(
                                  '🧠 ${avgNote.round()}/20', Colors.purpleAccent),
                            ],
                          ]),
