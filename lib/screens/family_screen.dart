...
class _FamilyScreenState extends State<FamilyScreen> {
  ...
  void _copyCode() {
    ...
    _showSnack('Code "$_familyCode" copié !');
  }
          ...
          return Dialog(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  const Text('Modifier le code famille',
                  ...
                  TvKeyboard(
                    ...
                    onDone: () {
                      ...
                      if (newCode.length >= 4) Navigator.pop(ctx, newCode);
                    },
                  ),
                ],
              ),
            ...
            children: [
              ...
              TvTextField(
                ...
                decoration: const InputDecoration(
                  hintText: 'NOUVEAU CODE', counterText: '',
      ...
      children: [
        ...
        Text('Synchronisation',
            style: TextStyle(fontSize: 20, fontWeight: FontWeight.w800, color: Colors.white,
                shadows: [Shadow(color: Colors.white.withValues(alpha: 0.2), blurRadius: 8)])),
        const Spacer(),
        TvFocusWrapper(
        ...
        children: [
          Container(
            ...
            child: Icon(
              ...
              color: isConnected ? const Color(0xFF00E676) : Colors.grey, size: 28,
            ),
          ),
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(isConnected ? 'Synchronisé' : 'Mode local',
                    style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700,
                        color: isConnected ? const Color(0xFF00E676) : Colors.grey)),
                const SizedBox(height: 4),
                Text(isConnected ? 'Données partagées en temps réel' : 'Les données restent sur cet appareil',
  ...
  Widget _buildConnectedView(Color primary) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        GlassCard(
          padding: const EdgeInsets.all(20), borderRadius: 20, glowColor: primary,
          child: Column(children: [
            const Text('Partagez ce code avec votre conjoint(e) :',
            ...
            TvFocusWrapper(
              ...
              child: Container(
                ...
                child: Column(children: [
                  Text(_familyCode ?? '...', style: TextStyle(fontSize: 36, fontWeight: FontWeight.w900, color: primary,
                      shadows: [Shadow(color: primary.withValues(alpha: 0.5), blurRadius: 12)])),
            ...
            SizedBox(width: double.infinity, child: OutlinedButton.icon(
              ...
              label: const Text('Se déconnecter', style: TextStyle(color: Colors.orange)),
      ...
      children: [
        ...
        GlassCard(
          ...
          child: Column(children: [
            ...
            const SizedBox(height: 16),
            const Text('Créez une famille et obtenez un code à partager.',
                textAlign: TextAlign.center, style: TextStyle(color: Colors.white70)),
            const SizedBox(height: 14),
            Row(children: [
              const Expanded(child: Text('Code personnalisé', style: TextStyle(color: Colors.white70, fontSize: 14))),
              Switch(value: _useCustomCode, onChanged: (v) => setState(() => _useCustomCode = v)),
            ]),
            if (_useCustomCode) ...[
              const SizedBox(height: 8),
              TvTextField(
                ...
                hintText: 'Ex: SKS2025',
                maxLength: 10,
                keyboardTitle: 'Code famille personnalisé',
            ...
            SizedBox(width: double.infinity, child: TvFocusWrapper(
              ...
              child: FilledButton.icon(
                ...
                label: Text(_useCustomCode ? 'Créer avec mon code' : 'Créer ma famille',
  ...
  Widget _buildJoinSection(Color primary) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        GlassCard(
          padding: const EdgeInsets.all(20), borderRadius: 20, glowColor: Colors.orange,
          child: Column(children: [
            Container(
              width: 64, height: 64,
            ...
            const SizedBox(height: 16),
            const Text('Entrez le code partagé par votre conjoint(e).',
                textAlign: TextAlign.center, style: TextStyle(color: Colors.white70)),
            const SizedBox(height: 16),
            TvTextField(
              ...
              maxLength: 10,
              keyboardTitle: 'Entrez le code famille',
              style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, letterSpacing: 4, color: Colors.white),
    ...
    return GlassCard(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Text('Comment ça marche ?', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: primary)),
        ]),
