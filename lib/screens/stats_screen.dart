  ...
  Widget build(BuildContext context) {
    return Consumer<FamilyProvider>(
      builder: (context, fp, _) {
        ...
        // Protection : maxPoints ne peut jamais être 0
        final maxPoints =
            sorted.isNotEmpty && sorted.first.points > 0 ? sorted.first.points : 1;
        ...
        for (final child in children) {
          ...
          for (final h in history) {
            if (h.isBonus) {
              ...
              totalPenalty++;
              totalPoints -= h.points; // points est toujours positif dans le modèle
            }
          }
        }
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        AnimatedBuilder(
                          ...
                          builder: (context, _) {
                            final val =
                                (child.points * _barController.value).round();
                            return Text('$val pts',
                                style: TextStyle(
                                    color: color,
                                    fontWeight: FontWeight.bold,
                        ...
                        return ClipRRect(
                          ...
                          child: Stack(children: [
                            ...
                            FractionallySizedBox(
                              widthFactor:
                                  (ratio * _barController.value).clamp(0.0, 1.0),
                              child: Container(
                                height: 14,
                                decoration: BoxDecoration(
      ...
      builder: (context, _) {
        return GridView.count(
          ...
          children: List.generate(cards.length, (i) {
            ...
            final delay = i * 0.2;
            final progress =
                ((_cardController.value - delay) / (1.0 - delay)).clamp(0.0, 1.0);
            final curved =
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TweenAnimationBuilder<int>(
                        // totalPts peut être négatif → on affiche la valeur brute
                        tween: IntTween(begin: 0, end: card.value.abs()),
...
class _SummaryData {
  final String label;
  final int value; // ← int direct, plus de parse String
  final IconData icon;
  final Color color;
