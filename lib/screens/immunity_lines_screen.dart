...
class ImmunityLinesScreen extends StatelessWidget {
        ...
        appBar: AppBar(
          ...
          bottom: TabBar(
            ...
            tabs: const [
              ...
              Tab(icon: Icon(Icons.history), text: 'Terminees'),
            ],
          ),
        ),
  ...
  void _showAddImmunity(BuildContext context) {
    ...
    final textCtrl = TextEditingController(text: 'Je suis dispensé(e) de cette tâche grâce à mon immunité.');
    ...
    final immunityTypes = [
      {'value': 'corvee', 'label': 'Corvee', 'icon': Icons.cleaning_services_rounded, 'emoji': '\u{1F9F9}'},
      {'value': 'punition', 'label': 'Punition', 'icon': Icons.shield_rounded, 'emoji': '\u{1F6E1}'},
      {'value': 'devoir', 'label': 'Devoir', 'icon': Icons.menu_book_rounded, 'emoji': '\u{1F4DA}'},
      {'value': 'custom', 'label': 'Speciale', 'icon': Icons.star_rounded, 'emoji': '\u{2B50}'},
    ];
                ...
                Row(
                  children: [
                    Container(
                      width: 40, height: 40,
                      decoration: BoxDecoration(
                        color: _shieldColor.withValues(alpha: 0.12),
                        shape: BoxShape.circle,
                        border: Border.all(color: _shieldColor.withValues(alpha: 0.3)),
                      ),
                    ...
                    return GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: isSelected ? [BoxShadow(color: _shieldColor.withValues(alpha: 0.15), blurRadius: 8)] : null,
                        ),
                        child: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                color: isSelected ? _shieldColor : Colors.grey[500],
                  ...
                  child: FilledButton.icon(
                    ...
                    onPressed: () {
                      ...
                      if (textCtrl.text.trim().isNotEmpty && selectedChildId != null && lines > 0 && lines <= 1000) {
                        provider.addImmunity(selectedChildId!, textCtrl.text.trim(), lines, selectedType);
                        Navigator.pop(ctx);
                      }
                    },
                    icon: const Icon(Icons.shield_rounded),
...
class _ImmunityCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GlassCard(
      ...
      glowColor: im.isCompleted ? const Color(0xFFFFD740) : _shieldColor,
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${im.completedLines} / ${im.totalLines} lignes',
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: im.isCompleted
                      ...
                      : _shieldColor.withValues(alpha: 0.12),
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(
                    color: im.isCompleted
                        ? const Color(0xFFFFD740).withValues(alpha: 0.3)
                        : _shieldColor.withValues(alpha: 0.3),
                  ),
                ),
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    ...
                    Text(
                      im.isCompleted ? 'Active' : im.immunityLabel,
                      style: TextStyle(
                        color: im.isCompleted ? const Color(0xFFFFD740) : _shieldColor,
                ...
                Expanded(
                  child: OutlinedButton.icon(
                    style: OutlinedButton.styleFrom(
                      foregroundColor: _shieldColor,
                      side: const BorderSide(color: _shieldColor),
          ...
          if (im.isCompleted) ...[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                  colors: [
                    ...
                    _shieldColor.withValues(alpha: 0.08),
                  ],
                ),
              ...
              child: const Row(
                ...
                children: [
                  Icon(Icons.verified_rounded, color: Color(0xFFFFD740), size: 20),
                  SizedBox(width: 8),
                  Text(
                    'Immunite activee !',
                    style: TextStyle(color: Color(0xFFFFD740), fontWeight: FontWeight.w700, fontSize: 14),
                  ),
                ],
              ),
            ),
          ...
          const SizedBox(height: 8),
          Text(
            'Attribue le ${im.createdAt.day}/${im.createdAt.month}/${im.createdAt.year}',
          ...
          children: [
            ...
            Wrap(
              ...
              children: options.map((n) => FilledButton(
                ...
                onPressed: () {
                  for (var i = 0; i < n; i++) {
                    provider.incrementImmunityLines(im.id);
                  }
                  Navigator.pop(ctx);
                },
                child: Text('+$n lignes'),
