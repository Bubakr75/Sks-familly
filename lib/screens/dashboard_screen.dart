...
class _DashboardScreenState extends State<DashboardScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final totalBadges =
        provider.children.fold<int>(0, (s, c) => s + c.badgeIds.length);
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        child: Row(
                          children: [
                            _buildStatChip(Icons.star_rounded,
                                '$totalPoints pts', primary, isDark),
                            ...
                            _buildStatChip(
                                ...
                                isDark),
                            const SizedBox(width: 8),
                            _buildStatChip(Icons.emoji_events_rounded,
                                '$totalBadges', const Color(0xFFFFD700), isDark),
                          ],
                        ),
                      ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          _buildQuickAction(Icons.edit_note_rounded, 'Punition',
                              const Color(0xFFFF1744), isDark, () {
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          _buildQuickAction(Icons.school_rounded, 'Notes',
                              const Color(0xFF448AFF), isDark, () {
                            if (provider.children.isNotEmpty) {
                              _showSchoolNotesChildPicker(context, provider);
                            }
                          }),
                          const SizedBox(width: 8),
                          _buildQuickAction(Icons.child_care_rounded, 'Enfant',
                              const Color(0xFFFF9800), isDark, () {
                            _showChildModePicker(context, provider);
                          }),
                          const SizedBox(width: 8),
                          _buildQuickAction(Icons.emoji_events_rounded, 'Badges',
