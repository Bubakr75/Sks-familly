          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                _pointChip('+10', const Color(0xFF00E676), isDark, () { provider.addPoints(child.id, 10, 'Tres bien !', 'Bonus'); Navigator.pop(ctx); setState(() => _showConfetti = true); }),
                _pointChip('+20', const Color(0xFF00E676), isDark, () { provider.addPoints(child.id, 20, 'Excellent !', 'Bonus'); Navigator.pop(ctx); setState(() => _showConfetti = true); }),
                ...
                _pointChip('-5', const Color(0xFFFF1744), isDark, () { provider.addPoints(child.id, -5, 'Mauvais comportement', 'Penalite', isBonus: false); Navigator.pop(ctx); }),
                _pointChip('-10', const Color(0xFFFF1744), isDark, () { provider.addPoints(child.id, -10, 'Sanction', 'Penalite', isBonus: false); Navigator.pop(ctx); }),
              ],
            ),
            const SizedBox(height: 24),
          ],
