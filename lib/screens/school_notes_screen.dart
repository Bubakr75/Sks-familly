...
class _SchoolNotesScreenState extends State<SchoolNotesScreen> {
  ...
  Widget build(BuildContext context) {
    return Consumer<FamilyProvider>(
      builder: (context, provider, _) {
        ...
        final notes = provider.getSchoolNotesForChild(widget.childId);
        ...
        return AnimatedBackground(
          child: Scaffold(
            ...
            floatingActionButton: TvFocusWrapper(
              onSelect: () => _showAddNote(provider),
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Padding(
                        ...
                        child: TvFocusWrapper(
                          onSelect: () => _showNoteDetail(note, provider),
                          child: GlassCard(
                            child: Padding(
                              padding: const EdgeInsets.all(16),
                              child: Row(
  ...
  void _showNoteDetail(dynamic note, FamilyProvider provider) {
    showModalBottomSheet(
      context: context,
      backgroundColor: Colors.transparent,
      builder: (ctx) {
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: TvFocusWrapper(
                  onSelect: () {
                    provider.deleteSchoolNote(note.id);
                    Navigator.pop(ctx);
                    setState(() {});
                  },
