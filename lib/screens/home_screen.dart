            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [const Color(0xFF0A0E21), primary.withValues(alpha: 0.15), const Color(0xFF0D1B2A)],
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [BoxShadow(color: primary.withValues(alpha: 0.4), blurRadius: 16, spreadRadius: -2)],
                    ),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: provider.isSyncEnabled ? const Color(0xFF00E676).withValues(alpha: 0.12) : Colors.grey.withValues(alpha: 0.12),
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(color: provider.isSyncEnabled ? const Color(0xFF00E676).withValues(alpha: 0.3) : Colors.grey.withValues(alpha: 0.2)),
                    ),
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(color: provider.isSyncEnabled ? const Color(0xFF00E676) : Colors.grey, fontSize: 12, fontWeight: FontWeight.w600),
                        ),
                      ],
                    ),
                  ),
              ...
              child: ListView(
                ...
                children: [
                  ...
                  _DrawerItem(icon: Icons.shield_rounded, label: 'Lignes d\'immunite', color: const Color(0xFF00E676),
                    ...
                    onTap: () { Navigator.pop(context); PinGuard.guardNavigation(context, ImmunityLinesScreen()); }),
                  Padding(padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 4), child: Divider(color: Colors.white.withValues(alpha: 0.06))),
                  _DrawerItem(icon: Icons.people_alt_rounded, label: 'Gerer les enfants', color: const Color(0xFF00E5FF),
                    ...
                    onTap: () { Navigator.pop(context); PinGuard.guardNavigation(context, ManageChildrenScreen()); }),
                  _DrawerItem(icon: Icons.sticky_note_2_rounded, label: 'Notes', color: const Color(0xFFFFD740),
                    subtitle: '${provider.notes.length} notes',
                    onTap: () { Navigator.pop(context); if (provider.children.isNotEmpty) _showNotesChildPicker(context, provider); }),
                  _DrawerItem(icon: provider.isSyncEnabled ? Icons.cloud_done_rounded : Icons.cloud_off_rounded, label: 'Synchronisation',
                    ...
                    onTap: () { Navigator.pop(context); Navigator.push(context, _glassRoute(const FamilyScreen())); }),
                  Padding(padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 4), child: Divider(color: Colors.white.withValues(alpha: 0.06))),
                  _DrawerItem(icon: Icons.history_rounded, label: 'Historique complet', color: const Color(0xFF7C4DFF),
                    subtitle: '${provider.history.length} activites',
                    onTap: () { Navigator.pop(context); _showFullHistoryPage(context, provider); }),
                ],
              ),
            ),
