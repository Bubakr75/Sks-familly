...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  Widget _buildGlassNavBar(PinProvider pin, Color primary) {
    ...
    final items = [
      ...
      _NavItem(Icons.add_circle_outline, Icons.add_circle_rounded, 'Points',
      ...
      _NavItem(Icons.settings_outlined, Icons.settings_rounded, 'Reglages',
          locked: pin.isPinSet && !pin.isParentMode),
    ];
        ...
        child: BackdropFilter(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(color: primary.withValues(alpha: 0.08), blurRadius: 20, spreadRadius: -5)
              ],
            ),
            child: Row(
                                  ...
                                  child: Icon(
                                    ...
                                    color: (isSelected || hasFocus)
                                        ...
                                        : isDark
                                            ? Colors.grey[600]
                                            : Colors.grey[500],
                                    shadows: (isSelected || hasFocus) && isDark
        ...
        child: Column(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(colors: [
                  isDark ? const Color(0xFF0A0E21) : primary.withValues(alpha: 0.05),
                  primary.withValues(alpha: 0.15),
                  isDark ? const Color(0xFF0D1B2A) : primary.withValues(alpha: 0.02),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('${provider.children.length} enfants - ${provider.history.length} activites',
                      style: TextStyle(color: isDark ? Colors.white.withValues(alpha: 0.6) : Colors.black45, fontSize: 13)),
                  ...
                  Container(
                    ...
                    child: Row(mainAxisSize: MainAxisSize.min, children: [
                      Icon(provider.isSyncEnabled ? Icons.cloud_done : Icons.cloud_off,
                          size: 14, color: provider.isSyncEnabled ? const Color(0xFF00E676) : Colors.grey),
                      const SizedBox(width: 6),
                      Text(provider.isSyncEnabled ? 'Synchronise' : 'Mode local',
                          style: TextStyle(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Divider(color: isDark ? Colors.white.withValues(alpha: 0.06) : Colors.black.withValues(alpha: 0.06)),
                  ),
                  _DrawerItem(
                    ...
                    onTap: () {
                      Navigator.pop(context);
                      Navigator.push(context, _glassRoute(const TribunalScreen()));
                    },
                  ),
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 4),
                  ...
                  _DrawerItem(
                    ...
                    onTap: () {
                      Navigator.pop(context);
                      if (provider.children.isNotEmpty) _showNotesChildPicker(context, provider);
                    },
                  ),
                  _DrawerItem(
            ...
            Container(
              ...
              child: Text('SKS Family v4.8.0', style: TextStyle(color: Colors.grey[700], fontSize: 12)),
            ),
          ],
        ),
      ),
  ...
  void _showSchoolNotesChildPicker(BuildContext context, FamilyProvider provider) {
    showModalBottomSheet(
      context: context,
      backgroundColor: Theme.of(context).brightness == Brightness.dark ? const Color(0xFF141833) : Colors.white,
        ...
        builder: (_, sc) => Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Expanded(
              child: ListView(
                controller: sc,
                children: provider.children.map((child) => TvFocusWrapper(
                  onTap: () {
                    Navigator.pop(ctx);
                    Navigator.push(context, MaterialPageRoute(builder: (_) => SchoolNotesScreen(childId: child.id)));
                  },
                  focusBorderColor: const Color(0xFF448AFF),
