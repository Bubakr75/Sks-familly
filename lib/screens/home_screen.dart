...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void _showChildPicker(BuildContext context, {required Function(String childId) onSelected}) {
    ...
    if (children.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text('Aucun enfant enregistré. Ajoute-en un d\'abord !'),
                  ...
                  child: TvFocusWrapper(
                    ...
                    child: GlassCard(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text('${child.points} points — ${child.levelTitle}',
                    ...
                    child: allHistory.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (_, index) {
                              ...
                              final isBonus = entry.isBonus as bool;
                              final points = entry.points as int;
                              final reason = entry.reason as String;
                              final date = entry.date as DateTime;
                              final category = entry.category as String;

                              final displayReason = reason.contains('|')
                                  ? reason.split('|').first
                                  : reason;
                                    ...
                                    ? Dismissible(
                                        ...
                                        confirmDismiss: (_) async {
                                          return await showDialog<bool>(
                                            ...
                                            builder: (dCtx) => AlertDialog(
                                              ...
                                              content: Text(
                                                '"$displayReason"\n'
                                                '${isBonus ? '+' : ''}$points pts — $childName\n\n'
                                                'Les points seront ajustés automatiquement.',
                                              ),
                                              actions: [
                                                TextButton(
                                                  onPressed: () =>
                                        ...
                                        onDismissed: (_) {
                                          ...
                                          ScaffoldMessenger.of(context).showSnackBar(
                                            SnackBar(
                                              content: Text(
                                                  '🗑️ Supprimé : "$displayReason" — points ajustés'),
                                              backgroundColor:
          ...
          child: Column(
            ...
            children: [
              ...
              _drawerItem(
                ...
                emoji: '🏆',
                title: 'Badges',
                subtitle: 'Récompenses et pouvoirs',
                onTap: () {
                  Navigator.pop(context);
                  Navigator.push(
                    context,
              ...
              if (isParent) ...[
                ...
                _drawerItem(
                  ...
                  subtitle: 'Gérer points, historique, données',
    ...
    return Padding(
      ...
      child: Text(
        ...
        style: TextStyle(
          fontSize: 11,
          fontWeight: FontWeight.bold,
          color: color?.withOpacity(0.7) ?? Colors.white38,
          letterSpacing: 1.5,
        ),
      ),
    );
        ...
        child: GlassCard(
          ...
          child: ListTile(
            ...
            trailing: Icon(
              Icons.chevron_right,
              size: 18,
              color: titleColor?.withOpacity(0.5) ?? Colors.white24,
            ),
          ),
        ),
      ),
  ...
  int _getTotalHistoryCount(FamilyProvider provider) {
    ...
    for (final child in provider.children) {
      count += provider.getHistory(child.id).length;
    }
    return count;
  }
