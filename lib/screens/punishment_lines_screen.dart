...
class _PunishmentLinesScreenState extends State<PunishmentLinesScreen>
  ...
  void _showQuizDialog(PunishmentLines p, ChildModel child,
      FamilyProvider fp, List<Map<String, dynamic>> questions,
      String theme) {
    int currentIndex = 0;
    int score = 0;
    int? selectedAnswer;
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 8),
                              _baremeRow(
                                  '18 – 20', '5 lignes', note >= 18),
                              _baremeRow('15 – 17', '3 lignes',
                                  note >= 15 && note < 18),
                              _baremeRow('12 – 14', '1 ligne',
                                  note >= 12 && note < 15),
                              _baremeRow(
                                  '< 12', 'Aucune réduction', note < 12),
                            ],
                          ),
                        ),
                        const SizedBox(height: 16),
