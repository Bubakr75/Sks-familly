...
class _ChildDashboardScreenState extends State<ChildDashboardScreen>
  ...
  // Jours pour le calculateur (onglet Écran)
  static const _jours = [
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // ── Cercle temps d'écran samedi (existant) ─────
          ...
          // ── Boutons bonus (visible parent seulement) ───
          if (isParent) ...[
          ...
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                // Notes comportementales (EN AVANT - plus grandes)
                Row(children: [
                  const Text('🧠',
  ...
  // ── Onglets Historique et Badges (inchangés) ───────────────
    ...
    if (allBadges.isEmpty) {
      return Center(
        child: TweenAnimationBuilder<double>(
          ...
          duration: const Duration(milliseconds: 800),
          builder: (context, value, ch) =>
              Opacity(opacity: value, child: Transform.scale(scale: value, child: ch)),
...
class _ScreenTimePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawArc(Rect.fromCircle(center: center, radius: radius),
        -1.5708, 6.2832 * progress, false, progressPaint);
    if (progress > 0.01) {
