...
class _AddPointsScreenState extends State<AddPointsScreen> {
  ...
  final List<String> _bonusReasons = [
    'Devoirs faits', 'Chambre rangee', 'Bon comportement', 'Aide menage',
    'Lecture', 'Sport', 'Politesse', 'Initiative',
  ];

  final List<String> _penaltyReasons = [
    'Desobeissance', 'Bagarre', 'Mensonge', 'Ecran abusif',
    'Desordre', 'Retard', 'Insolence', 'Devoirs non faits',
  ];
  ...
  Future<void> _submitPoints() async {
    if (_selectedChildId == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Selectionnez un enfant')),
      );
      return;
    }
