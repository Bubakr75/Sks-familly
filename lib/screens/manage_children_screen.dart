            ...
            children: [
              Padding(
                ...
                child: Row(children: [
                  ...
                  const Expanded(
                    child: NeonText(text: 'Gérer les enfants', fontSize: 20, color: Colors.white),
                  ),
                              ...
                              onSelected: (val) {
                                if (val == 'edit') {
                                  ...
                                  PinGuard.guardAction(
                                    context,
                                    () => _showPhotoOptions(context, child.id, provider),
                                  );
                                } else if (val == 'delete') {
                                  PinGuard.guardAction(
                                    context,
                                    () => _confirmDelete(context, child.id, child.name, provider),
                                  );
                                }
                              },
                              itemBuilder: (_) => const [
          ...
          content: SingleChildScrollView(
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              const Align(
                ...
                child: Text('Avatar', style: TextStyle(color: Colors.white70, fontSize: 13)),
              ),
              const SizedBox(height: 8),
              Wrap(
                spacing: 8,
