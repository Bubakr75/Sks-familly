...
class _ManageChildrenScreenState extends State<ManageChildrenScreen> {
                              ...
                              onSelected: (val) {
                                if (val == 'edit') {
                                  ...
                                  PinGuard.guardAction(
                                      context,
                                      () => _showPhotoOptions(
                                          context, child.id, provider));
                                } else if (val == 'delete') {
                                  PinGuard.guardAction(
                                      context,
                                      () => _confirmDelete(context,
                                          child.id, child.name, provider));
                                }
                              },
                              itemBuilder: (_) => const [
  ...
  void _showPhotoOptions(
      BuildContext context, String childId, FamilyProvider provider) {
  ...
  void _confirmDelete(BuildContext context, String childId, String childName,
