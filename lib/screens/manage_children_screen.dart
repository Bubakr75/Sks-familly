// lib/screens/manage_children_screen.dart
import 'dart:convert';
...
class _ManageChildrenScreenState extends State<ManageChildrenScreen> {
    ...
    return Scaffold(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton.extended(
          heroTag: 'add_child',
          onPressed: () =>
              PinGuard.guardAction(context, () => _showAddDialog(context)),
          ...
          actions: [
            ...
            FilledButton(
              onPressed: () {
                ...
                // Photo : récupère le dernier enfant ajouté de manière sûre
                if (photoBase64 != null) {
                  final children = provider.children;
                  if (children.isNotEmpty) {
                    provider.updateChildPhoto(
                        children.last.id, photoBase64!);
                  }
                }
          ...
          actions: [
            ...
            FilledButton(
              onPressed: () {
                ...
                context
                    .read<FamilyProvider>()
                    .updateChild(child.id, name, selectedAvatar);
                if (ctx.mounted) Navigator.pop(ctx);
              },
  ...
  void _showPhotoOptions(BuildContext context, String childId,
  ...
  void _confirmDelete(BuildContext context, String childId,
      String childName, FamilyProvider provider) {
    showDialog(
      context: context,
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
            'Supprimer $childName et toutes ses données ?',
