$content = Get-Content "lib/screens/punishment_lines_screen.dart" -Raw -Encoding UTF8
...
Write-Host "Occurrences trouvees: $count" -ForegroundColor Cyan
$content = $content.Replace($old, $new)
[System.IO.File]::WriteAllText("lib/screens/punishment_lines_screen.dart", $content, [System.Text.Encoding]::UTF8)
